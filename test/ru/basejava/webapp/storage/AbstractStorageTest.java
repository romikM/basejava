...
public abstract class AbstractStorageTest {
    ...
    public void getAll() throws Exception {
        ...
        assertArrayEquals(list, Arrays.asList(RESUME_1, RESUME_2, RESUME_3));
    }

    private boolean assertArrayEquals(List<Resume> arrA, List<Resume> arrB) {
        if (arrA == null && arrB == null) return true;

        if ((arrA == null && arrB!= null) || (arrA != null && arrB== null) || (arrA.size() != arrB.size()))
        {
            return false;
        }
